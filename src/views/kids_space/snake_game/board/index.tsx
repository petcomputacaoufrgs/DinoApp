...
const BoardGame: React.FC = () => {
    ...
    function renderSnake(gameBoard) {
        ...
        if(gameBoard) {
            snakeBody.forEach((segment, index) => {
                ...
                gameBoard.current.appendChild(snakePiece)
            })
        }
    }
    ...
    }, [lastInputDirection.x, lastInputDirection.y, main, xDown, yDown])

    return (
        <div ref= { gameBoard } className='snake_game__game_board'></div>
    )
}
